...
wget --no-check-certificate "https://github.com/vitoharhari/argon-themev19/raw/main/luci-app-argon-config_0.8-beta_all.ipk" -P /root/argon-theme && chmod +x /root/argon-theme/luci-app*
wget --no-check-certificate "https://github.com/vitoharhari/argon-themev19/raw/main/luci-theme-argon_2.2.5-20200914_all.ipk" -P /root/argon-theme && chmod +x /root/argon-theme/luci-theme*
...
echo -e "\033[1;32m theme ini khusus untuk openwrt v19 !!!\033[0m"
